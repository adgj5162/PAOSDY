...
<div class="col-md-12 section">
	...
	<form name="writeForm" action="./NoticeUpdateAction.nb" method="post">
	  <div class="form-group form-inline">
	    <label for="title">제목</label>
		<input type="text" name="title" id="title" class="form-control" value="<%=nbdto.getNoticeboard_title()%>"> 
	  </div>
		<textarea id="summernote" name="content"><%=nbdto.getNoticeboard_content() %></textarea>
		
		<input type="hidden" name="pageNum" value="<%=pageNum%>">
		<input type="hidden" name="noticeboard_num" value="<%=nbdto.getNoticeboard_num()%>">
